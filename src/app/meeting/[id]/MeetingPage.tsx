...
import useLoadCall from "@/hooks/userLoadCall";
...
export default function MeetingPage({ id }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      {description ? (
        ...
        <p className="text-center">
          This meeting doesn&apos;t have a description.
        </p>
      )}
      {setupComplete ? (
        <>
...
function SetupUI({ onSetupComplete }: SetupUIProps) {
  ...
  }, [call.camera, call.microphone, micCamDisabled]);
